...
from helpers.synthesizers import TestSynthesizer
...
if __name__ == '__main__':
    ...
    if args.type == "pretrain":
        ...
        test(ensemble_model, test_loader)
        # ===============================================
        #  resets global model (above is just to do fed avg) == not done in heter setting because Fed Avg is not model agnostic
        global_model = get_model(args)
        # ===============================================
        ...
        # test generator (loader from the given dataset !)
